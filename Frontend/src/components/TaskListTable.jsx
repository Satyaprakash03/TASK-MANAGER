          ...
          {tableData?.map((task) => (
            <tr key={task._id} className="border-t border-gray-200">
              ...
              <td className="py-4 px-4">
                <span
                  className={`px-2 py-1 text-xs font-medium rounded inline-block ${getStatusBadgeColor(task.status)}`}
                >
                  {" "}
                  {task.status}{" "}
                </span>
              ...
              <td className="py-4 px-4">
                <span
                  className={`px-2 py-1 text-xs font-medium rounded inline-block ${getPriorityBadgeColor(task.priority)}`}
                >
                  {" "}
                  {task.priority}{" "}
                </span>
